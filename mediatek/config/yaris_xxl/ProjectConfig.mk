...
CUSTOM_HAL_IMGSENSOR=s5k3h7y_mipi_raw ov8865_mipi_raw gc2035_yuv hi258_yuv hi257_yuv

# = CUSTOM_HAL_MAIN_LENS +CUSTOM_HAL_MAIN_BACKUP_LENS + CUSTOM_HAL_SUB_LENS + CUSTOM_HAL_SUB_BACKUP_LENS
CUSTOM_HAL_LENS=bu6424af sensordrive dummy_lens ov8865af
...
CUSTOM_HAL_MAIN_BACKUP_LENS=ov8865af
...
CUSTOM_HAL_MAIN_IMGSENSOR=s5k3h7y_mipi_raw
...
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR=hi258_yuv hi257_yuv
...
CUSTOM_KERNEL_IMGSENSOR=s5k3h7y_mipi_raw ov8865_mipi_raw gc2035_yuv hi258_yuv hi257_yuv
...
CUSTOM_KERNEL_LENS=bu6424af sensordrive dummy_lens
...
CUSTOM_KERNEL_MAIN_IMGSENSOR=s5k3h7y_mipi_raw
...
CUSTOM_KERNEL_SUB_BACKUP_IMGSENSOR=hi258_yuv hi257_yuv
...
#modify by xiaoguang.xiong,for add ft6x06's driver.CR 472612.
CUSTOM_KERNEL_TOUCHPANEL=ft5406 GT915
...
CUSTOM_LK_LCM=nt35517_yaris_xxl_tdt otm9605a_yaris_xxl  
...
# FR 466963 quanshui.ye@tct-nj.com 2013-07-18 begin
#MTK_ASF_PLAYBACK_SUPPORT=yes
MTK_ASF_PLAYBACK_SUPPORT=no
# FR 466963 quanshui.ye@tct-nj.com 2013-07-18 end
...
MTK_RELEASE_PACKAGE=rel_customer_basic rel_customer_platform rel_customer_operator_att rel_customer_operator_cmcc rel_customer_operator_cu rel_customer_operator_orange rel_customer_operator_vodafone
...
MTK_VLW_APP=yes
#PR549765, For MTK solution is not OK, so close the Feature.
...
RESOURCE_OVERLAY_SUPPORT=generic navbar qHD sd_in_ex_otg sd_ex_otg
...
CUSTOM_MODEM=jrdsh82_wet_jb5_hspa
...
CUSTOM_KERNEL_LCM=nt35517_yaris_xxl_tdt otm9605a_yaris_xxl

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=nt35517_yaris_xxl_tdt otm9605a_yaris_xxl
...
MTK_BUILD_VERNO = ALPS.JB5.MP.V1.1

# added by LeiBo for YarisXXL pretecting LCD backlight IC(2013.11.15)
YARISXXL_PRETECT_BACKLIGHT_IC=yes
# added by yfpan for customization nvram for wifi US version
JRD_AUDIO_PARAMS_CUST_M=yes

#added by YAN Qing for power-off charging percentage display
JRD_CHARGING_PERCENT_DISPLAY=yes

YARISXXL_GPS_ACCURACY=yes
