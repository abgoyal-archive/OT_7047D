...
#ifdef BUILD_LK
#ifdef YARISXXL_PRETECT_BACKLIGHT_IC
extern unsigned int backlightOn;
#endif
#endif
static struct LCM_setting_table lcm_initialization_setting[] = {
    ...
    // DC voltage for CPT
    {0x00,1, {0x91}},
    {0xC5,1, {0x76}},//VGH=15V, VGL=-10V
    {REGFLAG_DELAY, 1, {}},

    {0x00,1, {0x00}},
    {0xD8,2, {0x6F,0x6F}},//GVDD, NGVDD
    {REGFLAG_DELAY, 1, {}},
    ...
    {0x00,1, {0x00}},
    /*{0xE1,16, {0x00,0x07,0x0D,0x0E,0x05,0x10,0x0B,0x09,0x03,0x07,0x0B,0x08,0x0F,0x12,0x0C,0x03}},*/
	{0xE1,16, {0x00,0x07,0x0C,0x0F,0x06,0x11,0x0B,0x09,0x03,0x07,0x0B,0x08,0x0F,0x10,0x0D,0x03}},
    {REGFLAG_DELAY, 1, {}},

    {0x00,1, {0x00}},
    /*{0xE2,16, {0x00,0x08,0x0D,0x0D,0x05,0x10,0x0B,0x09,0x03,0x07,0x0B,0x08,0x0F,0x12,0x0C,0x03}},*/
    {0xE2,16, {0x00,0x07,0x0D,0x0F,0x06,0x11,0x0B,0x09,0x03,0x07,0x0B,0x08,0x0F,0x10,0x0D,0x03}},
    {REGFLAG_DELAY, 1, {}},
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////
    {0x00,1, {0xB4}},
    ...
    {0x00,1, {0x00}},
    {0xEC,33, {0x40,0x44,0x44,0x44,0x44,0x34,0x44,0x44,0x44,0x44,0x44,\
	    0x44,0x44,0x44,0x44,0x44,0x34,0x44,0x44,0x44,0x44,0x44,\
	    0x44,0x44,0x44,0x44,0x44,0x43,0x44,0x44,0x44,0x44,0x04}},
    {REGFLAG_DELAY, 1, {}},

    {0x00,1, {0x00}},
    {0xED,33, {0x40,0x44,0x44,0x34,0x44,0x44,0x44,0x44,0x44,0x44,0x43,\
	    0x44,0x44,0x44,0x44,0x44,0x34,0x44,0x44,0x44,0x44,0x44,\
	    0x34,0x44,0x44,0x44,0x44,0x44,0x44,0x43,0x44,0x44,0x04}},
    {REGFLAG_DELAY, 1, {}},

    {0x00,1, {0x00}},
    {0xEE,33, {0x40,0x44,0x44,0x44,0x44,0x44,0x44,0x44,0x44,0x44,0x44,\
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	// Bit rate calculation
   	 ...
   	 params->dsi.fbk_div =16;    // fref=26MHz, fvco=fref*(fbk_div+1)*2/(div1_real*div2_real//20)	///==24
