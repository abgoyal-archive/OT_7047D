...
extern LCM_DRIVER nt35517_yaris_xxl_tdt_drv;
extern LCM_DRIVER hx8379a_yaris_xl_vdo_drv;
extern LCM_DRIVER ili9806c_yaris_xl_byd_drv;
extern LCM_DRIVER otm9605a_yaris_xxl_byd_drv; //added by yanglian,20130913
extern LCM_DRIVER hx8389b_qhd_dsi_vdo_eclipse_lcm_drv;//added by bo.lei for eclipse project,20131021
extern LCM_DRIVER nt35517_eclipse_tdt_drv;//added by bo.lei for eclipse project,20131104

LCM_DRIVER* lcm_driver_list[] = 
{ 

#if defined(OTM9605A_YARIS_XXL)     //added by yanglian,20130913
	&otm9605a_yaris_xxl_byd_drv,
#endif

#if defined(NT35517_ECLIPSE_TDT)     //added by bo.lei,20131021
	&nt35517_eclipse_tdt_drv,
#endif

#if defined(HX8389B_QHD_DSI_VDO_ECLIPSE)     //added by bo.lei,20131021
	&hx8389b_qhd_dsi_vdo_eclipse_lcm_drv,
#endif
#if defined(NT35517_YARIS_XXL_TDT)
	&nt35517_yaris_xxl_tdt_drv,
#endif

#if defined(ILI9806C_YARIS_XL)
	&ili9806c_yaris_xl_byd_drv,
#endif

#if defined(HX8379A_YARIS_XL)
	&hx8379a_yaris_xl_vdo_drv,
#endif
