...
void GC0329_night_mode(kal_bool bEnable)
{
	if (bEnable)
	{
		...
		GC0329_write_cmos_sensor(0x13, 0x98);
	...
	else 
	{
		GC0329_SET_PAGE1;
		GC0329_write_cmos_sensor(0x11, 0xa1);
		GC0329_write_cmos_sensor(0x13, 0x78);
		if(GC0329_MPEG4_encode_mode == KAL_TRUE)
			{
			GC0329_SET_PAGE0;
			GC0329_write_cmos_sensor(0xfa, 0x00);
		...
		GC0329_write_cmos_sensor(0xde, 0x30);//2013.01.29
		GC0329_GAMMA_Select(GC0329_RGB_Gamma_m2);		//GC0329_RGB_Gamma_m1 20130606
	}
...
void GC0329_Sensor_Init(void)
{
	...
	GC0329_write_cmos_sensor(0x33, 0x1b); //20  20130606
	...
	GC0329_write_cmos_sensor(0x82, 0x08);
	GC0329_write_cmos_sensor(0x83, 0x01); 
	...
	////////////////////RGB gamma////////////////////
	GC0329_write_cmos_sensor(0xfe, 0x00);
	GC0329_write_cmos_sensor(0xbf, 0x0c);
	GC0329_write_cmos_sensor(0xc0, 0x1c);
	GC0329_write_cmos_sensor(0xc1, 0x3b);
	GC0329_write_cmos_sensor(0xc2, 0x5c);
	GC0329_write_cmos_sensor(0xc3, 0x74);
	GC0329_write_cmos_sensor(0xc4, 0x89);
	GC0329_write_cmos_sensor(0xc5, 0x9b);
	GC0329_write_cmos_sensor(0xc6, 0xb3);
	GC0329_write_cmos_sensor(0xc7, 0xc3);
	GC0329_write_cmos_sensor(0xc8, 0xd0);
	GC0329_write_cmos_sensor(0xc9, 0xdb);
	GC0329_write_cmos_sensor(0xca, 0xe3);
	GC0329_write_cmos_sensor(0xcb, 0xea);
	GC0329_write_cmos_sensor(0xcc, 0xf0);
	GC0329_write_cmos_sensor(0xcd, 0xf7);
	GC0329_write_cmos_sensor(0xce, 0xfd);
	GC0329_write_cmos_sensor(0xcf, 0xff);
	...
	GC0329_write_cmos_sensor(0x64, 0x10);
	GC0329_write_cmos_sensor(0x65, 0x1c);
	GC0329_write_cmos_sensor(0x66, 0x30);
	GC0329_write_cmos_sensor(0x67, 0x43);
	GC0329_write_cmos_sensor(0x68, 0x54);
	GC0329_write_cmos_sensor(0x69, 0x65);
	GC0329_write_cmos_sensor(0x6a, 0x75);
	GC0329_write_cmos_sensor(0x6b, 0x93);
	GC0329_write_cmos_sensor(0x6c, 0xb0);
	GC0329_write_cmos_sensor(0x6d, 0xcb);
	GC0329_write_cmos_sensor(0x6e, 0xe6);
	...
	GC0329_write_cmos_sensor(0xb8, 0xed);
	//skin
	...
	GC0329_write_cmos_sensor(0xd1, 0x2c); 
	GC0329_write_cmos_sensor(0xd2, 0x2c);
	GC0329_write_cmos_sensor(0xd3, 0x38);	// 40  20130606

	////////////////////AEC////////////////////
	GC0329_write_cmos_sensor(0xfe, 0x01);
	GC0329_write_cmos_sensor(0x10, 0x00);
	GC0329_write_cmos_sensor(0x11, 0xa1);
	GC0329_write_cmos_sensor(0x12, 0x04); //06
	GC0329_write_cmos_sensor(0x13, 0x78); //50 40
	GC0329_write_cmos_sensor(0x17, 0x88);
	GC0329_write_cmos_sensor(0x21, 0xc8);
	GC0329_write_cmos_sensor(0x22, 0x68);
	GC0329_write_cmos_sensor(0x3c, 0x95);//95
	GC0329_write_cmos_sensor(0x3d, 0x50);//50
	GC0329_write_cmos_sensor(0x3e, 0x48);//90
	...
	GC0329_write_cmos_sensor(0x55, 0x20); //10
	GC0329_write_cmos_sensor(0x56, 0x60); //20	//GC0329_write_cmos_sensor(0x57, 0x40); 
	...
	GC0329_write_cmos_sensor(0x5c, 0x37);//3
	GC0329_write_cmos_sensor(0x5d, 0x73);
	GC0329_write_cmos_sensor(0x5e, 0x10);
	...
	GC0329_write_cmos_sensor(0x80, 0x70);
	...
	///////////////////ABS///////////////////////
	GC0329_write_cmos_sensor(0x9c, 0x02);   // 04 20130606
	...
	GC0329_write_cmos_sensor(0xa8, 0x05);
	GC0329_write_cmos_sensor(0xa9, 0x07);
	GC0329_write_cmos_sensor(0xaa, 0x00);
	GC0329_write_cmos_sensor(0xab, 0x02);
	GC0329_write_cmos_sensor(0xac, 0x00);
	GC0329_write_cmos_sensor(0xad, 0x00);
	GC0329_write_cmos_sensor(0xae, 0x03);
	GC0329_write_cmos_sensor(0xaf, 0x03);
	GC0329_write_cmos_sensor(0xb0, 0x00);
	GC0329_write_cmos_sensor(0xb1, 0x06);
	GC0329_write_cmos_sensor(0xb2, 0x06);
	GC0329_write_cmos_sensor(0xb3, 0x00);
	GC0329_write_cmos_sensor(0xb4, 0x42);
	GC0329_write_cmos_sensor(0xb5, 0x30);
	GC0329_write_cmos_sensor(0xb6, 0x30);
	GC0329_write_cmos_sensor(0xba, 0x37);
	GC0329_write_cmos_sensor(0xbb, 0x2b);
	GC0329_write_cmos_sensor(0xbc, 0x28);
	GC0329_write_cmos_sensor(0xc0, 0x0e);
	GC0329_write_cmos_sensor(0xc1, 0x0b);
	GC0329_write_cmos_sensor(0xc2, 0x0c);
	GC0329_write_cmos_sensor(0xc6, 0x19);
	GC0329_write_cmos_sensor(0xc7, 0x16);
	GC0329_write_cmos_sensor(0xc8, 0x16);
	GC0329_write_cmos_sensor(0xb7, 0x10);
	GC0329_write_cmos_sensor(0xb8, 0x00);
	GC0329_write_cmos_sensor(0xb9, 0x15);
	GC0329_write_cmos_sensor(0xbd, 0x08);
	GC0329_write_cmos_sensor(0xbe, 0x00);
	GC0329_write_cmos_sensor(0xbf, 0x00);
	GC0329_write_cmos_sensor(0xc3, 0x00);
	GC0329_write_cmos_sensor(0xc4, 0x02);
	GC0329_write_cmos_sensor(0xc5, 0x01);
	GC0329_write_cmos_sensor(0xc9, 0x04);
	...
	//20130606 add banding
	GC0329_write_cmos_sensor(0x05, 0x01);
	GC0329_write_cmos_sensor(0x06, 0x32);//30
	...
	GC0329_write_cmos_sensor(0x2a, 0x64);   //anti-flicker step [7:0]
		
	GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  30.00fps
	GC0329_write_cmos_sensor(0x2c, 0x58); 
	GC0329_write_cmos_sensor(0x2d, 0x03);   //exp level 0  15.00fps
	GC0329_write_cmos_sensor(0x2e, 0xe8); 
	GC0329_write_cmos_sensor(0x2f, 0x05);   //exp level 0  10.00fps
	GC0329_write_cmos_sensor(0x30, 0xdc); 
...
BOOL GC0329_set_param_banding(UINT16 para)
{
	switch (para)
	{
		case AE_FLICKER_MODE_50HZ:
			...
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x29, 0x00);   //anti-flicker step [11:8]
			GC0329_write_cmos_sensor(0x2a, 0x78);   //anti-flicker step [7:0]
				
			GC0329_write_cmos_sensor(0x2b, 0x02);   //exp level 0  30.00fps
			GC0329_write_cmos_sensor(0x2c, 0x58); 
			GC0329_write_cmos_sensor(0x2d, 0x04);   //exp level 1  14.29fps
			GC0329_write_cmos_sensor(0x2e, 0xb0); 
			GC0329_write_cmos_sensor(0x2f, 0x07);   //exp level 2  10.00fps
			GC0329_write_cmos_sensor(0x30, 0x80); 
			GC0329_write_cmos_sensor(0x31, 0x09);   //exp level 3  5.26fps
			GC0329_write_cmos_sensor(0x32, 0x60); 
			GC0329_write_cmos_sensor(0xfe, 0x00);
			GC0329_SET_PAGE0;
...
BOOL GC0329_set_param_exposure(UINT16 para)
{
	switch (para)
	{
		...
		case AE_EV_COMP_07:
			...
			GC0329_SET_PAGE1;
			GC0329_write_cmos_sensor(0x13, 0x88);
			GC0329_SET_PAGE0;
		break;
