...
typedef struct
{
	...
	//Preview
	  ...
	  #define S5K3H7Y_PV_PERIOD_LINE_NUMS 					(0x04F0) //(0x092E) //(0x0940)  	//(0x0940=2368
	 //Video
	 #define S5K3H7Y_VIDEO_PERIOD_PIXEL_NUMS				(0x1CD0) 	// 0x0E68=3688
	 #define S5K3H7Y_VIDEO_PERIOD_LINE_NUMS					(0x04B0) //(0x0928)  	//(0x0928=2344
	 //capture 
	...
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH_SETTING 		(1632)
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING		(918)
 ...
 #else
	//Preview 
	  #define S5K3H7Y_PV_PERIOD_PIXEL_NUMS					(0x0EA8) 	// 0x0E68=3688
