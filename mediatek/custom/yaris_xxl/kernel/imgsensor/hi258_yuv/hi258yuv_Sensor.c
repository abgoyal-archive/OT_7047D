...
HI258_write_cmos_sensor(0x23, 0x08); //Col L
...
HI258_write_cmos_sensor(0x40, 0x01); //Hblank 260
HI258_write_cmos_sensor(0x41, 0x04); 
...
HI258_write_cmos_sensor(0x92, 0xc8); //BLC_AG_TH_ON
HI258_write_cmos_sensor(0x93, 0xc0); //BLC_AG_TH_OFF
...
HI258_write_cmos_sensor(0xd6, 0xc8); //DCDC_AG_TH_ON
HI258_write_cmos_sensor(0xd7, 0xc0); //DCDC_AG_TH_OFF
...
HI258_write_cmos_sensor(0x41, 0x08); //D-YOffset Th
...
HI258_write_cmos_sensor(0x61, 0x7b); //Sat B 7b
HI258_write_cmos_sensor(0x62, 0x85); //Sat R 80
HI258_write_cmos_sensor(0x63, 0x80); //Auto-De Color

HI258_write_cmos_sensor(0x66, 0x42);
HI258_write_cmos_sensor(0x67, 0x22);

HI258_write_cmos_sensor(0x6a, 0x8a); //White Protection Offset Dark/Indoor 5a
...
HI258_write_cmos_sensor(0x21, 0xc0); //Y-Center

HI258_write_cmos_sensor(0x22, 0x59); //LSC R 1b->15 20130125  57  4c
HI258_write_cmos_sensor(0x23, 0x3d); //LSC G   3c  37  3b
HI258_write_cmos_sensor(0x24, 0x35); //LSC B   38  36
...
HI258_write_cmos_sensor(0x14, 0x52);	//CMCOFSGH 
HI258_write_cmos_sensor(0x15, 0x30);	//CMCOFSGM
HI258_write_cmos_sensor(0x16, 0x20);	//CMCOFSGL
HI258_write_cmos_sensor(0x17, 0x2f);	//CMC SIGN
//CMC
HI258_write_cmos_sensor(0x30, 0x89);
HI258_write_cmos_sensor(0x31, 0x5c);
HI258_write_cmos_sensor(0x32, 0x13);
HI258_write_cmos_sensor(0x33, 0x17);
HI258_write_cmos_sensor(0x34, 0x5c);
HI258_write_cmos_sensor(0x35, 0x05);
HI258_write_cmos_sensor(0x36, 0x07);
HI258_write_cmos_sensor(0x37, 0x45);
HI258_write_cmos_sensor(0x38, 0x8c);
//CMC OFS
HI258_write_cmos_sensor(0x40, 0x08);
HI258_write_cmos_sensor(0x41, 0x84);
HI258_write_cmos_sensor(0x42, 0x85);
HI258_write_cmos_sensor(0x43, 0x04);
HI258_write_cmos_sensor(0x44, 0x05);
HI258_write_cmos_sensor(0x45, 0x89);
HI258_write_cmos_sensor(0x46, 0x90);
HI258_write_cmos_sensor(0x47, 0x8b);
HI258_write_cmos_sensor(0x48, 0x1b);
//CMC POFS
HI258_write_cmos_sensor(0x50, 0x83);
HI258_write_cmos_sensor(0x51, 0x85);
HI258_write_cmos_sensor(0x52, 0x08);
HI258_write_cmos_sensor(0x53, 0x03);
HI258_write_cmos_sensor(0x54, 0x09);
HI258_write_cmos_sensor(0x55, 0x8d);
HI258_write_cmos_sensor(0x56, 0x00);
HI258_write_cmos_sensor(0x57, 0x07);
HI258_write_cmos_sensor(0x58, 0x87);
///// PAGE 15 END /////
...
//Indoor
HI258_write_cmos_sensor(0x30, 0x00);
HI258_write_cmos_sensor(0x31, 0x06);
HI258_write_cmos_sensor(0x32, 0x0c);
HI258_write_cmos_sensor(0x33, 0x1a);
HI258_write_cmos_sensor(0x34, 0x4b);
HI258_write_cmos_sensor(0x35, 0x69);
HI258_write_cmos_sensor(0x36, 0x81);
HI258_write_cmos_sensor(0x37, 0x98);
HI258_write_cmos_sensor(0x38, 0xae);
HI258_write_cmos_sensor(0x39, 0xbd);
HI258_write_cmos_sensor(0x3a, 0xc8);
HI258_write_cmos_sensor(0x3b, 0xd3);
HI258_write_cmos_sensor(0x3c, 0xdc);
HI258_write_cmos_sensor(0x3d, 0xe2);
HI258_write_cmos_sensor(0x3e, 0xe8);
HI258_write_cmos_sensor(0x3f, 0xee);
HI258_write_cmos_sensor(0x40, 0xf3);
...
HI258_write_cmos_sensor(0x2b, 0x34); //Adaptive Off,1/100 Flicker 04
...
HI258_write_cmos_sensor(0x70, 0x50); //6c   58
...
HI258_write_cmos_sensor(0x84, 0xf9); 
HI258_write_cmos_sensor(0x85, 0xb2); 
HI258_write_cmos_sensor(0x86, 0x01); //EXPMin 13800.42 fps
HI258_write_cmos_sensor(0x87, 0xd7); 
HI258_write_cmos_sensor(0x88, 0x0c); //EXP Max 60hz 8.00 fps 
HI258_write_cmos_sensor(0x89, 0x65); 
HI258_write_cmos_sensor(0x8a, 0xbb); 
HI258_write_cmos_sensor(0xa5, 0x0b); //EXP Max 50hz 8.33 fps 
HI258_write_cmos_sensor(0xa6, 0xe6); 
HI258_write_cmos_sensor(0xa7, 0xc8); 
HI258_write_cmos_sensor(0x8B, 0xfd); //EXP100 
HI258_write_cmos_sensor(0x8C, 0xe6); 
HI258_write_cmos_sensor(0x8D, 0xd3); //EXP120 
HI258_write_cmos_sensor(0x8E, 0x95); 
HI258_write_cmos_sensor(0x9c, 0x21); //EXP Limit 766.69 fps 
HI258_write_cmos_sensor(0x9d, 0x1e); 
HI258_write_cmos_sensor(0x9e, 0x01); //EXP Unit 
HI258_write_cmos_sensor(0x9f, 0xd7); 
HI258_write_cmos_sensor(0xa3, 0x00); //Outdoor Int 
HI258_write_cmos_sensor(0xa4, 0xd3);  

HI258_write_cmos_sensor(0xb0, 0x15);
HI258_write_cmos_sensor(0xb1, 0x14);
HI258_write_cmos_sensor(0xb2, 0xd0);//80
...
//Indoor Weight
HI258_write_cmos_sensor(0x20, 0x66);
HI258_write_cmos_sensor(0x21, 0x66);
HI258_write_cmos_sensor(0x22, 0x66);
HI258_write_cmos_sensor(0x23, 0x66);
HI258_write_cmos_sensor(0x24, 0x66);
HI258_write_cmos_sensor(0x25, 0x66);
HI258_write_cmos_sensor(0x26, 0x66);
HI258_write_cmos_sensor(0x27, 0x66);
HI258_write_cmos_sensor(0x28, 0x66);
HI258_write_cmos_sensor(0x29, 0x44);
HI258_write_cmos_sensor(0x2a, 0x44);
HI258_write_cmos_sensor(0x2b, 0x66);
HI258_write_cmos_sensor(0x2c, 0x66);
HI258_write_cmos_sensor(0x2d, 0x42);
HI258_write_cmos_sensor(0x2e, 0x24);
HI258_write_cmos_sensor(0x2f, 0x66);
HI258_write_cmos_sensor(0x30, 0x66);
HI258_write_cmos_sensor(0x31, 0x42);
HI258_write_cmos_sensor(0x32, 0x24);
HI258_write_cmos_sensor(0x33, 0x66);
HI258_write_cmos_sensor(0x34, 0x66);
HI258_write_cmos_sensor(0x35, 0x44);
HI258_write_cmos_sensor(0x36, 0x44);
HI258_write_cmos_sensor(0x37, 0x66);
HI258_write_cmos_sensor(0x38, 0x66);
HI258_write_cmos_sensor(0x39, 0x66);
HI258_write_cmos_sensor(0x3a, 0x66);
HI258_write_cmos_sensor(0x3b, 0x66);
HI258_write_cmos_sensor(0x3c, 0x66);
HI258_write_cmos_sensor(0x3d, 0x66);
HI258_write_cmos_sensor(0x3e, 0x66);
HI258_write_cmos_sensor(0x3f, 0x76);
...
void HI258_night_mode(kal_bool enable)	
{
    ...
    if (enable) 
    {
        ...
        if (HI258_Banding_setting == AE_FLICKER_MODE_50HZ) 
        {
            ...
            HI258_write_cmos_sensor(0x89, 0xd5);
            HI258_write_cmos_sensor(0x8a, 0xf8);

			        //EXP Max 50hz
            HI258_write_cmos_sensor(0xa5, 0x13); //EXP Max 5 fps
            HI258_write_cmos_sensor(0xa6, 0xd5);
            HI258_write_cmos_sensor(0xa7, 0xf8);
...
{	
   ...
   // HI258_write_cmos_sensor(0x10, 0x69);
    ...
    HI258_write_cmos_sensor(0x40, 0x01); //Hblank 378  260
    HI258_write_cmos_sensor(0x41, 0x04); 
    HI258_write_cmos_sensor(0x42, 0x00); //Vblank 20
    HI258_write_cmos_sensor(0x43, 0x14); 
