...
HI257WriteCmosSensor(0x10, 0x10);
HI257WriteCmosSensor(0x11, 0x90); //Windowing On + 1Frame Skip
HI257WriteCmosSensor(0x12, 0x04); //HI257WriteCmosSensor(0x12, 0x00); //Rinsing edge 0x04 // Falling edge 0x00  //yange  test
HI257WriteCmosSensor(0x14, 0x05);

HI257WriteCmosSensor(0x20, 0x00); //Row H
HI257WriteCmosSensor(0x21, 0x0a); //Row L
HI257WriteCmosSensor(0x22, 0x00); //Col H
HI257WriteCmosSensor(0x23, 0x08); //Col L
...
HI257WriteCmosSensor(0x2f, 0xa7);// 11 jacky
...
HI257WriteCmosSensor(0x49, 0xd1);//20130604 0x87->0xd1
...
HI257WriteCmosSensor(0x10, 0x03); //S2D enable _ YUYV Order ??
...
HI257WriteCmosSensor(0x50, 0x98); //D-YOffset AG  

HI257WriteCmosSensor(0x60, 0x4f);
HI257WriteCmosSensor(0x61, 0x70); //Sat B 84
HI257WriteCmosSensor(0x62, 0x80); //Sat R 80
HI257WriteCmosSensor(0x63, 0x70); //Auto-De Color
...
HI257WriteCmosSensor(0x74, 0x06); //White Protection Offset Outdoor 08
...
HI257WriteCmosSensor(0x26, 0x88); // Double_AG
HI257WriteCmosSensor(0x27, 0x82); // Double_AG
...
HI257WriteCmosSensor(0x82, 0x72); //Sharp2D Filter  //jacky 73
...
HI257WriteCmosSensor(0x20, 0x80); //X-Center   //a0 dnp
HI257WriteCmosSensor(0x21, 0x80); //Y-Center   //b0

HI257WriteCmosSensor(0x22, 0x17); //LSC R 1b->15 20130125  15  //dnp 1c
HI257WriteCmosSensor(0x23, 0x11); //LSC G   12                 //15
HI257WriteCmosSensor(0x24, 0x11); //LSC B  11                   //17
...
HI257WriteCmosSensor(0x33, 0x2f);
HI257WriteCmosSensor(0x34, 0x5b);
HI257WriteCmosSensor(0x35, 0x75);
HI257WriteCmosSensor(0x36, 0x8c);
HI257WriteCmosSensor(0x37, 0xa0);
HI257WriteCmosSensor(0x38, 0xb2);
HI257WriteCmosSensor(0x39, 0xc0);
HI257WriteCmosSensor(0x3a, 0xcd);
HI257WriteCmosSensor(0x3b, 0xd7);
HI257WriteCmosSensor(0x3c, 0xe0);
HI257WriteCmosSensor(0x3d, 0xe8);
HI257WriteCmosSensor(0x3e, 0xee);
...
HI257WriteCmosSensor(0x52, 0x10);
HI257WriteCmosSensor(0x53, 0x26);
HI257WriteCmosSensor(0x54, 0x43);
HI257WriteCmosSensor(0x55, 0x5d);
HI257WriteCmosSensor(0x56, 0x79);
HI257WriteCmosSensor(0x57, 0x8c);
HI257WriteCmosSensor(0x58, 0x9f);
HI257WriteCmosSensor(0x59, 0xaa);
HI257WriteCmosSensor(0x5a, 0xb6);
HI257WriteCmosSensor(0x5b, 0xc3);
HI257WriteCmosSensor(0x5c, 0xce);
HI257WriteCmosSensor(0x5d, 0xd9);
HI257WriteCmosSensor(0x5e, 0xe1);
HI257WriteCmosSensor(0x5f, 0xe9);
...
HI257WriteCmosSensor(0x72, 0x1c);
HI257WriteCmosSensor(0x73, 0x2e);
HI257WriteCmosSensor(0x74, 0x4e);
HI257WriteCmosSensor(0x75, 0x6c);
HI257WriteCmosSensor(0x76, 0x82);
HI257WriteCmosSensor(0x77, 0x96);
HI257WriteCmosSensor(0x78, 0xa7);
HI257WriteCmosSensor(0x79, 0xb6);
HI257WriteCmosSensor(0x7a, 0xc4);
HI257WriteCmosSensor(0x7b, 0xd0);
HI257WriteCmosSensor(0x7c, 0xda);
HI257WriteCmosSensor(0x7d, 0xe2);
HI257WriteCmosSensor(0x7e, 0xea);
...
HI257WriteCmosSensor(0x1f, 0x35); //mcmc_sat_gain2
...
HI257WriteCmosSensor(0x11, 0x0c);//14
...
HI257WriteCmosSensor(0x70, 0x50); //6c  48
...
HI257WriteCmosSensor(0x83, 0x05); //EXP Normal 33.33 fps 
HI257WriteCmosSensor(0x84, 0xf3); 
HI257WriteCmosSensor(0x85, 0x64); 
...
HI257WriteCmosSensor(0x89, 0x65); 
HI257WriteCmosSensor(0x8a, 0xbb); 
HI257WriteCmosSensor(0xa5, 0x0b); //EXP Max(100Hz) 8.33 fps   
HI257WriteCmosSensor(0xa6, 0xe6); 
HI257WriteCmosSensor(0xa7, 0xc8); 
HI257WriteCmosSensor(0x8B, 0xfd); //EXP100 
HI257WriteCmosSensor(0x8C, 0xe6); 
HI257WriteCmosSensor(0x8D, 0xd3); //EXP120 
HI257WriteCmosSensor(0x8E, 0x95); 
HI257WriteCmosSensor(0x9c, 0x1b); //EXP Limit 920.03 fps 
...
HI257WriteCmosSensor(0xc3, 0x18); //2b
HI257WriteCmosSensor(0xc4, 0x10); //08
...
HI257WriteCmosSensor(0x24, 0x65);
HI257WriteCmosSensor(0x25, 0x55);
HI257WriteCmosSensor(0x26, 0x55);
HI257WriteCmosSensor(0x27, 0x56);
HI257WriteCmosSensor(0x28, 0x65);
HI257WriteCmosSensor(0x29, 0x44);
HI257WriteCmosSensor(0x2a, 0x44);
HI257WriteCmosSensor(0x2b, 0x56);
HI257WriteCmosSensor(0x2c, 0x65);
HI257WriteCmosSensor(0x2d, 0x43);
HI257WriteCmosSensor(0x2e, 0x34);
HI257WriteCmosSensor(0x2f, 0x56);
HI257WriteCmosSensor(0x30, 0x65);
HI257WriteCmosSensor(0x31, 0x43);
HI257WriteCmosSensor(0x32, 0x34);
HI257WriteCmosSensor(0x33, 0x56);
HI257WriteCmosSensor(0x34, 0x65);
HI257WriteCmosSensor(0x35, 0x44);
HI257WriteCmosSensor(0x36, 0x44);
HI257WriteCmosSensor(0x37, 0x56);
HI257WriteCmosSensor(0x38, 0x65);
HI257WriteCmosSensor(0x39, 0x55);
HI257WriteCmosSensor(0x3a, 0x55);
HI257WriteCmosSensor(0x3b, 0x56);
...
HI257WriteCmosSensor(0x19, 0x02);
...
HI257WriteCmosSensor(0x25, 0x4f); //2013-09-13 AWB Hunting
...
HI257WriteCmosSensor(0x80, 0x2a);//30
HI257WriteCmosSensor(0x81, 0x20);
HI257WriteCmosSensor(0x82, 0x30);// 2a

HI257WriteCmosSensor(0x83, 0x48);//58
HI257WriteCmosSensor(0x84, 0x16);
HI257WriteCmosSensor(0x85, 0x4f);
HI257WriteCmosSensor(0x86, 0x20);

HI257WriteCmosSensor(0x87, 0x35);// 3b
HI257WriteCmosSensor(0x88, 0x2a);//30
HI257WriteCmosSensor(0x89, 0x35);
HI257WriteCmosSensor(0x8a, 0x22);//18

HI257WriteCmosSensor(0x8b, 0x35);
HI257WriteCmosSensor(0x8c, 0x2c);
...
HI257WriteCmosSensor(0x10, 0x1c);
	...
	HI257WriteCmosSensor(0x84, 0xd5);
	HI257WriteCmosSensor(0x85, 0xf8);

HI257WriteCmosSensor(0xa5, 0x13); //EXP Max(100Hz) 5.00 fps   
	HI257WriteCmosSensor(0xa6, 0xd5);
	HI257WriteCmosSensor(0xa7, 0xf8);
...
HI257WriteCmosSensor(0x03,0x00);
	HI257WriteCmosSensor(0x10,0x10);//91
	...
	HI257WriteCmosSensor(0x40,0x01);//Hblank_284 260
	HI257WriteCmosSensor(0x41,0x04);
	HI257WriteCmosSensor(0x42,0x00);//Vblank
	HI257WriteCmosSensor(0x43,0x14);//Flick Stop
                    ...
                    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
  ...
  pSensorInfo->YUVAwbDelayFrame = 0; //3,
  pSensorInfo->YUVEffectDelayFrame = 0;//2. 
...
HI257WriteCmosSensor(0x01, 0x00); //Sleep Off
        ...
        default:
            SENSORDB("[HI257]SCENE_MODE default: %d\n", para);
            HI257NightMode(KAL_FALSE); ////MODE0=10-30FPS
...
HI257WriteCmosSensor(0x83, 0x48);//48
HI257WriteCmosSensor(0x84, 0x16);
HI257WriteCmosSensor(0x85, 0x50);
HI257WriteCmosSensor(0x86, 0x20);  //20   15  
      break;                     
    case AWB_MODE_AUTO:  
		  HI257SetPage(0x22);
HI257WriteCmosSensor(0x03, 0x22);
...
//HI257WriteCmosSensor(0x81, 0x20);
//HI257WriteCmosSensor(0x82, 0x32);
HI257WriteCmosSensor(0x83, 0x4d);//58
HI257WriteCmosSensor(0x84, 0x16);
HI257WriteCmosSensor(0x85, 0x50);
...
HI257WriteCmosSensor(0x03, 0x10);  
HI257WriteCmosSensor(0x11, 0x03);
HI257WriteCmosSensor(0x12, 0x13);
HI257WriteCmosSensor(0x13, 0x03);
...
HI257WriteCmosSensor(0x03, 0x10);  
HI257WriteCmosSensor(0x11, 0x03);
HI257WriteCmosSensor(0x12, 0x18);
HI257WriteCmosSensor(0x13, 0x03);
HI257WriteCmosSensor(0x44, 0x80);
HI257WriteCmosSensor(0x45, 0x80);
      break;
...
HI257WriteCmosSensor(0x45, 0x80);
  ...
  {
      HI257SetPage(0x10); 
      HI257WriteCmosSensor(0x12, HI257ReadCmosSensor(0x12)|0x10);
    //  HI257WriteCmosSensor(0x40, HI257Status.Brightness);	  
  }
  return KAL_TRUE;
...
//    case AE_EV_COMP_13:              /* EV +2 */
	  ...
	  case AE_EV_COMP_30:  //+3 EV
		...
		HI257WriteCmosSensor(0x40,0x48);
  spin_lock(&hi257_drv_lock);
		HI257Status.Brightness = 0x48;
  spin_unlock(&hi257_drv_lock);
      break;
    default:
      return KAL_FALSE;
  }
  SENSORDB("[HI257]HI257SetExposure HI257Status.Brightness:%d;\n",HI257Status.Brightness);
  return KAL_TRUE;
} /* HI257SetExposure */
...
void HI257set_brightness(UINT16 para)
{
    ...
    switch (para)
    {
		...
		HI257WriteCmosSensor(0x40, 0x00);
	spin_lock(&hi257_drv_lock); 
	//  HI257Status.Brightness = 0xa0;
	spin_unlock(&hi257_drv_lock);
             break;
        case ISP_BRIGHT_HIGH:
		HI257WriteCmosSensor(0x40, 0x00); 
		spin_lock(&hi257_drv_lock); 
	 // HI257Status.Brightness = 0x20;
	spin_unlock(&hi257_drv_lock);
             break;
...
void HI257set_contrast(UINT16 para)
{
  ...
  HI257SetPage(0x10);  
  spin_lock(&hi257_drv_lock);
  HI257Status.ISPCTL4 |= 0x02;
  spin_unlock(&hi257_drv_lock);
  HI257WriteCmosSensor(0x13,HI257Status.ISPCTL4);//make sure the Yoffset control is opened.
...
return;
	...
	//Low
	HI257WriteCmosSensor(0x03, 0x10);
	/*HI257WriteCmosSensor(0x61, 0x90); //Sat B
	HI257WriteCmosSensor(0x62, 0x90); //Sat R*/
	...
	HI257WriteCmosSensor(0x03, 0x10);
	//HI257WriteCmosSensor(0x61, 0x84); //Sat B
	//HI257WriteCmosSensor(0x62, 0x80); // SATR
             break;
    }
     return;
}
...
UINT32 HI257YUVSetVideoMode(UINT16 FrameRate)
{
	...
	HI257WriteCmosSensor(0x03, 0x00); //Page 0
	HI257WriteCmosSensor(0x40, 0x01); //Hblank 316
	HI257WriteCmosSensor(0x41, 0x04); 
  if(HI257Status.NightMode== KAL_TRUE)
  {
...
HI257WriteCmosSensor(0x85, 0xb2); 
...
HI257WriteCmosSensor(0xa5, 0x09); //EXP Max(100Hz) 10fps 
HI257WriteCmosSensor(0xa6, 0xea); 
HI257WriteCmosSensor(0xa7, 0xfc); 
...
void HI257GetDelayInfo(UINT32 delayAddr)
{
    ...
    pDelayInfo->InitDelay = 1;// 3
    pDelayInfo->EffectDelay = 1;// 2
    pDelayInfo->AwbDelay = 1;// 3
