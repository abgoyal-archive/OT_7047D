...
{{
    ...
    ISPCcmPoly22:{
        ...
        23389,    // i4B_STD
        {  // i4P00[9]
            4816667, -2400000, 143333, -606667, 3260000, -96667, 210000, -2010000, 4360000
        },
        {  // i4P10[9]
            925364, -1101085, 175721, 80306, -217973, 135384, 122558, -188141, 65583
        },
        {  // i4P01[9]
            747149, -789375, 42226, -154513, -248851, 407193, 52111, -417810, 365700
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AWB NVRAM
    {
        ...
        // AWB preference color	
        {
            ...
            {
            508,    // i4R  //518  //yange modified for reducing RG
            512,    // i4G
            512    // i4B
            },
