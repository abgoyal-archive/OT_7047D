...
#include "../../../platform/mt6582/kernel/drivers/power/fan5405.h"
 // ============================================================ //
 //define
 // ============================================================ //
 //cut off to full
 #define CHARGING_META //20131031 modified by yuan-li@tcl.com for PR547424
...
void select_charging_curret(void)
{
    ...
    {   
        ...
        {
        battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] xxxxxxjp NONSTANDARD_CHARGER !\n");
//add by wangping for jp charger start 
#if defined(YARISXXL_CHARGING_TEMPERATURE_PLOICY)
		if(g_jp_flag == 1) // jp charger
		{
		    battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] jp chager:set max current 1200mA !\n");
		    if(((BMT_status.temperature < CHARGE_TEMPERATURE_STEP1)&&
		     ...
		     {
		        g_temp_input_CC_value = CHARGE_CURRENT_600_00_MA;
		     ...
		     else
		     {
            	...
            	else  //none jp chager:500mA
            	 {
            	 	battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] none jp chager:500mA !\n");
        	...
        	g_temp_input_CC_value = NON_STD_AC_CHARGER_CURRENT;	
                g_temp_CC_value = NON_STD_AC_CHARGER_CURRENT;
#endif
//add by wangping for jp charger end
        } 
        else if (BMT_status.charger_type == STANDARD_CHARGER) 
        {
#if defined(YARISXL_CHARGING_TEMPERATURE_PLOICY) || defined(YARISXLTD_CHARGING_TEMPERATURE_PLOICY)
...
static void pchr_turn_on_charging (void)
{
    ...
    else if( ((g_platform_boot_mode==META_BOOT) || (g_platform_boot_mode==ADVMETA_BOOT))&&(upmu_get_rgs_baton_undet() ==0) )
    {   
        battery_xlog_printk(BAT_LOG_CRTI, "[BATTERY] In meta and valid battery exist, enable charging.\n");    
    ...
    else
    {
		...
		((BMT_status.temperature >= CHARGE_TEMPERATURE_STEP1)&&(charge_temperature_above_step2==1)))
			{
